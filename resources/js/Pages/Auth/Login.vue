...
<!-- 
        ...
        <form @submit.prevent="submit" class="fit-content flex flex-col items-center justify-center"> 
            ...
            <div class="w-full fit-content relative flex flex-col gap-1 px-10 py-9">
                ...
                <div>
                    <InputLabel for="email" value="Email" class="font-quicksand font-bold text-lg mb-1" />
                ...
                <div>
                    <InputLabel for="password" value="Password" class="font-quicksand font-bold text-base mt-6 mb-2"/>
