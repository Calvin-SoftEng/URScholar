<template>
    ...
    <AuthenticatedLayout class="shadow-md z-10">
        ...
        <div class="w-full h-full flex flex-col bg-gradient-to-b from-[#E9F4FF] via-white to-white dark:bg-gradient-to-b dark:from-[#1C2541] dark:via-[#0B132B] dark:to-[#0B132B] space-y-3 overflow-auto scrollbar-thin scrollbar-thumb-blue-400 scrollbar-track-gray-100 scrollbar-thumb-rounded">
            ...
            <div class="box-border h-full mx-auto max-w-7xl sm:px-3 lg:px-8">
                    ...
                    <div class="stepper-container max-w-full">
                            ...
                            <div v-if="activeStep === 0">
                                <div class="bg-white rounded-lg p-10 sm:p-5 xl:p-10 shadow-md">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                        <h4 class="text-md font-semibold text-gray-800 dark:text-gray-200 mb-3">Scholarship Eligibility Criteria</h4>
                                        <ul class="space-y-3">
                                            <li v-for="(criterion, index) in criteria" :key="index" class="flex items-center space-x-2">
                                            <span class="text-blue-600 font-medium">✔</span>
                                            <span class="text-gray-700 dark:text-gray-300">{{ criterion }}</span>
                                            </li>
                                        </ul>
                                        </div>
                                        ...
                                        <div>
                                        <h4 class="text-md font-semibold text-gray-800 dark:text-gray-200 mb-3">Your Eligibility Status</h4>
                                        <ul class="space-y-3">
                                            <li v-for="(detail, index) in userDetails" :key="index" class="flex items-center space-x-2">
                            ...
                            <div v-if="activeStep === 1">
                                <div class="bg-white grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3
                                    ...
                                    <div class="col-span-3 md:col-span-2">
                                        <label for="essay" class="block text-sm font-semibold text-gray-900 dark:text-white mb-1">
                                            Topic:
                                        </label>
                                        <p class="text-sm text-gray-600 dark:text-gray-300 mb-2">
                                            Describe yourself, your family, and your goals or aspirations in relation to the scholarship or financial assistance you are applying for.
                                        </p>
                        ...
                        <div class="flex-grow">
                            <div v-if="activeStep === 2">
                                <div class="bg-white grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2
                                    gap-6 rounded-lg h-1/2 items-center justify-start p-10 sm:p-5 xl:p-10 ">
                                        ...
                                        <div class="border rounded-lg p-3 bg-white shadow-sm w-full max-w-xl">
                                            ...
                                            <div class="flex justify-between items-center gap-5">
                                                <div class="flex items-center space-x-2">
                                                    <span class="bg-yellow-400 text-black font-bold px-2 py-1 rounded">A</span>
                                                    <span class="font-semibold text-gray-800">True Copy of Grades (TCG)</span>
                                                </div>
                                            ...
                                            <div v-if="file" class="border border-dashed border-purple-400 rounded-lg p-2 mt-2 flex items-center justify-between">
                                            <div class="flex items-center space-x-2">
                                                <img src="https://img.icons8.com/ios-filled/50/000000/pdf.png" class="w-6 h-6" alt="PDF Icon">
                                                <div>
                                                <p class="text-sm font-medium">{{ file.name }}</p>
                                                <p class="text-xs text-gray-500">{{ file.size }}</p>
                                                </div>
                                            </div>
                                            <button @click="removeFile" class="text-gray-600 hover:text-red-500">
                                                🗑️
                                            </button>
                                            </div>
                                        </div>
