                            ...
                            <div v-if="activeStep === 0">
                                <div class="bg-white grid grid-cols-3 gap-6 rounded-lg h-1/2 items-center justify-start p-10">
                                    ...
                                    <div class="grid w-full max-w-sm items-center gap-1.5">
                                        ...
                                        <Input id="email" type="text" placeholder="Last Name" v-model="form.last_name" class="w-full border-gray-200" />
                                    </div>

                                    <div class="grid w-full max-w-sm items-center gap-1.5">
                                        <Label for="email">Middle Name</Label>
                                        <Input id="email" type="text" placeholder="Middle Name" v-model="form.middle_name" class="w-full border-gray-200" />
                                    </div>

                                    <div class="grid w-full max-w-sm items-center gap-1.5">
                                        <Label for="email">Suffix Name</Label>
                                        <Input id="email" type="text" placeholder="Suffix Name" v-model="form.suffix" class="w-full border-gray-200" />
                                    </div>
                                    ...
                                    <div class="grid w-full max-w-sm items-center gap-1.5">
                                        ...
                                        <Input id="email" type="text" placeholder="Place of Birth" v-model="form.birthplace" class="w-full border-gray-200" />
                                    </div>

                                    <div class="grid w-full max-w-sm items-center gap-1.5">
                                        <Label for="email">Age</Label>
                                        <Input id="email" type="number" placeholder="Age" v-model="form.age" class="w-full border-gray-200" />
                                    </div>
                                    ...
                                    <div class="grid w-full max-w-sm items-center gap-1.5">
                                        ...
                                        <Input id="email" type="text" placeholder="Religion" v-model="form.religion" class="w-full border-gray-200" />
                                    </div>

                                    <div class="grid w-full max-w-sm items-center gap-1.5">
                                        <Label for="email">Guardian Name</Label>
                                        <Input id="email" type="text" placeholder="Guardian Name" v-model="form.guardian_name" class="w-full border-gray-200" />
                                    </div>

                                    <div class="grid w-full max-w-sm items-center gap-1.5">
                                        <Label for="email">Relationship</Label>
                                        <Input id="email" type="text" placeholder="Relationship" v-model="form.relationship" class="w-full border-gray-200" />
                                    </div>
