<template>
    ...
    <AuthenticatedLayout class="shadow-md z-10 h-full overflow-auto">
        ...
        <div class="pt-3 pb-3 sm:overflow-auto sm:max-h-[90vh] sm:scroll-py-2 overflow-auto h-full scroll-py-4 bg-gradient-to-b from-[#E9F4FF] via-white to-white">
            <div class="mx-auto w-10/12 sm:px-1 lg:px-8 h-full">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-3 h-full">
                <!-- Greeting and Scholarship Section -->
                <div class="w-full h-full col-span-1 space-y-3 flex flex-col items-center sm:mb-3">
                    <!-- Greeting -->
                    <div class="bg-primary w-full text-white text-3xl font-sans font-bold p-7 rounded-lg text-center">
                ...
                <div v-else class="w-full h-full col-span-2 block border-l border-gray-200 p-10 flex-col items-center mx-auto max-w-8xl sm:px-6 lg:px-8">
                    <div v-if="!applicant">
