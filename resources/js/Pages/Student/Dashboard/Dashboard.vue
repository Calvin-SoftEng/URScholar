            ...
            <div class="mx-auto sm:w-full lg:w-10/12 lg:px-8 h-full">
                <div class="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-3 gap-3 h-full">
                    ...
                    <div class="w-full flex flex-col items-center space-y-3 sm:space-y-0 gap-3 sm:px-3">
                        ...
                        <div class="hidden sm:block w-full space-y-3 bg-white dark:bg-dcontainer shadow-lg rounded-lg p-3">
                            ...
                            <div class="w-full space-y-3 flex flex-col">
                                <div class="w-full text-dtext bg-dsecondary dark:bg-dprimary rounded-lg flex items-center gap-2 p-3">
                    ...
                    <div v-else
                        ...
                        <div v-if="!applicant" class="w-full h-full bg-white dark:bg-dprimary rounded-lg shadow-md sm:p-5 lg:py-10 flex-col items-center mx-auto max-w-8xl sm:px-2 lg:px-8">
                            <Scholarships :sponsors="sponsors" :scholarships="scholarships" :schoolyears="schoolyears"
                                :scholar="scholar" :grade="grade" />
                        </div>
                        <div v-else class="w-full h-full bg-white dark:bg-dprimary rounded-lg shadow-md sm:p-5 lg:py-10 flex-col items-center mx-auto max-w-8xl sm:px-2 lg:px-8">
