<template>
    <SettingsLayout>
        <div class="bg-gray-50 w-full h-full p-10 flex flex-col space-y-5 overflow-auto">
            <h1 class="text-lg font-quicksand uppercase font-medium text-[darkblue] dark:text-dtext text-left mb-2">
                <span class="mr-2 font-kanit font-bold text-primary tracking-[-.1rem]">\\</span>
