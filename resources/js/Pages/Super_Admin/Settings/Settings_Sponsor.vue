<template>
    <SettingsLayout>
        <div
            class="w-full h-full px-16 py-10 flex flex-col space-y-5 overflow-auto scrollbar-thin scrollbar-thumb-blue-900 scrollbar-track-gray-100 scrollbar-thumb-rounded">
