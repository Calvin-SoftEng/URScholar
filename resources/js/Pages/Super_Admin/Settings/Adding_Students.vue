        ...
        <div class="bg-gray-50 dark:bg-dcontainer w-full h-full px-16 py-10 flex flex-col space-y-5 overflow-auto">
            ...
            <div class="w-full mt-5">
                <div class="relative overflow-x-auto border border-gray-200 rounded-lg w-full">
                    <div class="grid grid-cols-4 w-full py-1 items-center justify-between gap-10 bg-gray-50 dark:bg-gray-700">
                    ...
                    <table class="mt-2 w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 rounded-lg overflow-y-auto">
                ...
                <div  class="bg-white dark:bg-gray-900 dark:border-gray-200 rounded-lg shadow-xl w-4/12">
                    ...
                    <form @submit.prevent="submitForm" class="p-4 flex flex-col gap-3">
                        <div class="w-full flex flex-col">
                            <h3 class="font-semibold text-gray-900 dark:text-white mb-1">University Students current year</h3>
