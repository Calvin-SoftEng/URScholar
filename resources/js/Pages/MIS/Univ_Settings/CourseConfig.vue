        ...
        <div class="bg-dirtywhite dark:bg-dprimary p-6 h-full w-full">
            <div class="relative">
                ...
                <span class="absolute top-1 right-[-50px] flex flex-col items-center space-y-1">
                    <button>
                        <span
                            class="material-symbols-rounded px-2 py-1 rounded-full border-2 border-gray-300 dark:border-gray-600 
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4 w-full flex flex-row gap-2 justify-end">
                                            ...
                                            <button @click="toggleArchive" v-tooltip.right="'Archive'">
                                                <span
                                                    class="material-symbols-rounded p-2 font-medium text-white dark:text-blue-500 bg-red-500 rounded-lg">
                                                    inventory_2
                                                </span>
                                            </button>
                                        </td>
