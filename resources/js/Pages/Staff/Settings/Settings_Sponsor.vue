                        ...
                        <div class="w-full bg-white rounded-lg dark:bg-dsecondary dark:border dark:border-gray-200 border">
                            ...
                            <div class="flex flex-col px-6 py-6 h-full">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <div class="mb-2 flex flex-col items-center gap-4">
                                                <div class="w-40 h-32 p-2 border rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center">
                                                    <img alt="Sponsor Logo" class="object-cover w-full h-full">
                                                </div>
                                                <div class="w-full">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 px-6 py-4">
                                    <!-- First Column: Date (30%) -->
                                    <div class="w-full md:w-1/3 flex items-center">
                                        <span class="font-semibold text-gray-900 dark:text-white">September 30, 2023</span>
                                    </div>

                                    <!-- Second Column: File Name (70%) -->
