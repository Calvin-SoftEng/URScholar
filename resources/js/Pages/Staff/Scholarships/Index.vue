                    ...
                    <div class="mt-2 flex justify-between gap-2">
                        ...
                        <div class="flex justify-end gap-2">
                            ...
                            <button v-if="form.scholarshipType === 'Grant-Based'" type="submit"
                                class="text-white bg-gradient-to-r from-blue-700 via-blue-800 to-blue-900 hover:bg-navy hover:bg-gradient-to-br focus:ring-4 focus:ring-blue-300 shadow-lg rounded-lg text-sm px-5 py-2.5">
                                Create Scholarship
                            </button>
                        </div>
                    </div>
