<template>
    ...
    <div class="flex flex-col gap-3 flex-grow relative">
        ...
        <!-- <div v-if="scholarships.length === 0" class="flex items-center justify-center h-40 bg-gray-100 dark:bg-gray-700 rounded-xl p-4">
            ...
            <div class="max-h-40 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 dark:scrollbar-thumb-dprimary dark:scrollbar-track-dcontainer scrollbar-thumb-rounded flex flex-col justify-start gap-2">
                <div class="space-y-1">
        ...
        <div class="sticky bottom-0 left-0 w-full bg-white dark:bg-dcontainer">
            <Link :href="(route('sponsor.index'))">
                <button class="text-white font-sans w-full bg-gradient-to-r from-blue-700 via-blue-800 to-blue-900 hover:bg-gradient-to-br 
                    focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 
                    dark:shadow-lg dark:shadow-blue-900/90 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
