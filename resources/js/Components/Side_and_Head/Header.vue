      ...
      <div class="hidden lg:flex justify-between items-center h-[50px] place-content-center">
        ...
        <div class="flex items-center space-x-4 pr-5" >
          ...
          <div
            ...
            class="z-50 absolute top-full right-0 mt-2 w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow-lg dark:bg-gray-800 dark:divide-gray-700"
          >
            ...
            <div class="divide-y divide-gray-100 dark:divide-gray-700">
              <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                <div class="flex-shrink-0 relative">
                  <img class="rounded-full w-11 h-11" src="" alt="User image" />
                  <div
