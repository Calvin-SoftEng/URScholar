    ...
    <section class="relative py-16 px-40 min-h-screen items-center bg-white">
        ...
        <div class="flex flex-col text-center space-y-8 items-center justify-start h-full">
            <div class="text-left flex flex-col space-y-5">
                <span class="bg-gradient-to-r from-[#0D3B80] to-[#296fd6] bg-clip-text text-transparent font-sora text-2xl font-bold">Find Available and Ongoing Scholarships, Check Eligibility, and Apply <br></span>
                <p class="text-lg text-primary max-w-4xl font-medium font-albert text-center">Browse Scholarship Programs offered by the Nation’s Government and Local Governments. 
            ...
            <div class="flex flex-col space-y-4">
                <div class="p-4 bg-white border border-gray-200 rounded-xl shadow-md">
                    <div class="flex text-left gap-4">
                        <!-- Scholarship Image -->
                        <img src="" alt="Scholarship Image" class="w-16 h-16 rounded-md object-cover">

                        <!-- Scholarship Details -->
                        <div class="flex flex-col flex-grow space-y-2">
                            <span class="font-semibold text-lg">Tulong Dunong Program</span>
                            <span class="text-sm text-gray-600">Funded by <span class="font-medium">Since</span></span>
                            <p class="text-sm text-gray-700">
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consectetur reprehenderit saepe, cupiditate, 
                                facilis itaque sapiente, illo tempora id vero quod inventore perferendis dolorum iusto officiis 
                                praesentium cum eveniet deserunt architecto.
                            </p>
