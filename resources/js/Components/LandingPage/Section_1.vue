<template>
    <section class="relative py-14 px-6 text-center h-screen flex justify-center items-start bg-gradient-to-b from-[#E9F4FF] to-white" style="padding-top: 25vh;">
        ...
        <div class="relative z-10 space-y-6">
            ...
            <p class="text-3xl text-gray-400 max-w-2xl font-albert font-bold mx-auto">
                You could be a <span class="text-primary">potential</span> grantee.<br>
                Let’s find out together!
            </p>
            <button class="btn bg-white shadow text-primary text-lg font-bold font-sora mt-5 px-10">
                Check Now
            </button>
        </div>
    </section>
