<template>
    <!-- Desktop Navbar -->
    <nav
        class="hidden lg:flex items-center shadow-md bg-[#003366] mx-auto sticky top-3 rounded-lg z-50 px-5 py-2.5 max-w-screen-xl">
        <!-- Logo and Title -->
        <div class="flex flex-row items-center justify-center gap-2">
            <img :src="`/storage/branding/logos/${branding.logo_light}`" alt="Light Mode Logo"
                class="w-[40px] h-[40px] dark:hidden">
            <span class="font-poppins text-3xl font-bold text-white tracking-tight">{{branding.branding_name}}</span>
        </div>
        ...
        <div class="flex items-center space-x-4 ml-auto font-poppins">
            ...
            <span
                class="material-symbols-rounded fill-white opacity-0 translate-x-2 transition-all duration-300 ease-in-out group-hover:opacity-100 group-hover:translate-x-0 ml-1">
                arrow_right_alt
            </span>
            </Link>
    ...
    <nav class="lg:hidden border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700 sticky top-0 z-50">
            ...
            <div class="flex items-center space-x-4">
                <div class="pl-3">
                    <div class="flex flex-row items-center justify-center gap-2">
                        ...
                        <span
                            class="font-poppins text-3xl font-bold text-navy tracking-tight dark:text-white">URScholar</span>
                    </div>
                </div>
            </div>
            <!-- Hamburger Button -->
        ...
        <transition enter-active-class="transition-opacity duration-300 ease-out" enter-from-class="opacity-0"
            ...
            <div v-if="isOpen" id="menu-content"
                ...
                <ul
                    class="text-white h-full text-2xl font-medium space-y-6 text-center justify-center font-poppins w-full my-auto flex flex-col items-center">
                    <li class="transform transition-transform duration-300 hover:scale-110">
                        <Link :href="route('login')" class="block py-2 px-6 hover:text-gray-300 transition-colors">Login
                        </Link>
                    </li>
                    <li class="transform transition-transform duration-300 hover:scale-110">
                        <Link :href="route('register')" class="block py-2 px-6 hover:text-gray-300 transition-colors">Register</Link>
                    </li>
                    <!-- <li class="transform transition-transform duration-300 hover:scale-110">
