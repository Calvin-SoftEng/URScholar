            ...
            <div class="space-y-2">
                ...
                <div class="flex flex-row p-3 rounded-xl bg-gradient-to-r from-blue-500 to-blue-700 border border-blue-400 shadow-lg hover:shadow-xl transition-all duration-300 justify-between items-center text-white dark:from-dsecondary dark:to-dprimary dark:border-gray-600">
                    <div class="flex flex-col">
                        <span class="font-semibold text-lg">Tulong DUnong</span>
                        <div class="flex flex-row gap-1">
                            <span class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2 py-0.5 rounded-sm dark:bg-gray-700 dark:text-blue-400 border border-blue-400">
                                What Campus
                            </span>
                            <span class="font-normal text-sm">90/90 Completed</span>
                        </div>
                    </div>
                    <div class="flex flex-row items-center gap-2">
                        <!-- Check Icon -->
                        <font-awesome-icon :icon="['fas', 'circle-check']" class="text-green-500" />
                        <span class="text-sm font-medium">Sept 19, 2023</span>
                    </div>
                </div>
