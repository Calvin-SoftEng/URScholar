<template>
    <!-- Messages Container -->
    <div class="bg-white w-full h-full p-1 rounded-xl dark:bg-dcontainer dark:border dark:border-gray-600 flex flex-col">
        <!-- Messages Title -->
        ...
        <div
            class="flex-1 max-h-9/10 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 dark:scrollbar-thumb-dprimary dark:scrollbar-track-dcontainer scrollbar-thumb-rounded dark:border-gray-600 rounded-lg px-3 py-2 space-y-2">
            
            <!-- Activity List -->
            <ul class="w-full space-y-1 ">
            <li
                v-for="(activity, index) in activity_logs"
                :key="index"
