            ...
            <table class="table rounded-lg">
              ...
              <tbody>
                ...
                <tr v-for="scholar in eligibleScholars" :key="scholar.id" class="text-sm">
                 ...
                 <!-- Cut-Off Line -->
                <tr v-if="cutoffScholars.length > 0">
                  <td colspan="7" class="text-center font-semibold text-red-600 py-4 bg-red-50">
                    Cut-Off Line: Below applicants are NOT within the required 10 recipients.
                  </td>
                </tr>

                <!-- Cut-Off Scholars -->
                <tr v-for="scholar in cutoffScholars" :key="scholar.id" class="text-sm bg-gray-50">
                  <td>{{ scholar.urscholar_id }}</td>
                  ...
                  <td>
                    <span class="text-xs font-medium px-2.5 py-0.5 rounded w-full"
                      :class="{
                        'bg-green-100 text-green-800 border border-green-400': scholar.status === 'Complete',
                        'bg-gray-200 text-gray-500 border border-gray-400': scholar.status === 'No submission',
                        'bg-red-100 text-red-800 border border-red-400': scholar.status === 'Incomplete'
